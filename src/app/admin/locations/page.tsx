    ...
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-muted">Manage your location pages</p>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {locations.map((location) => (
            ...
            >
              ...
              <p className="text-sm text-muted mb-4">📍 {location.city}</p>
              <div className="flex gap-2">
                <Link href={`/admin/locations/${location.id}`} className="flex-1">
                  <Button
                    variant="outline"
        ...
        <div className="glass rounded-2xl p-12 border border-border text-center">
          <p className="text-muted mb-4">No locations yet</p>
          <Link href="/admin/locations/new">
            <Button variant="primary">Add your first location</Button>
          </Link>
        </div>
      )}
    </div>
