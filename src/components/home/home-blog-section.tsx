...
function BlogThumb({ category, className }: { category: string; className?: string }) {
  return (
    <div
      aria-hidden
      className={cn(
...
function FeaturedCard({ post }: { post: BlogPost }) {
  return (
    ...
    >
      <BlogThumb category={post.category} className="aspect-[16/10] w-full shrink-0 sm:aspect-[5/3]" />
