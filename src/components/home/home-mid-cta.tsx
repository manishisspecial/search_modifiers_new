...
export function HomeMidCta() {
  ...
  return (
    <motion.div
      ...
      className="spotlight-card relative overflow-hidden rounded-2xl border border-dashed border-cyan-500/20 bg-gradient-to-r from-cyan-500/[0.05] via-transparent to-violet-500/[0.05] px-6 py-12 sm:px-12"
    >
