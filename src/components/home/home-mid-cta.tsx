...
export function HomeMidCta() {
  ...
  return (
    <>
      <motion.div
        initial={reduce || !mounted ? false : { opacity: 0, scale: 0.97 }}
      ...
      >
        ...
        <div className="relative flex flex-col items-center gap-8 text-center md:flex-row md:justify-between md:text-left">
          ...
          <Button onClick={() => open("Homepage - Mid CTA")} className="group shrink-0 px-8 py-3.5 text-base">
            Book the call
      ...
      <CtaFormModal
        ...
        subtitle="No pitch deck, just an honest conversation about your goals."
        source={source}
      />
    </>
  );
